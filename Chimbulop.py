...
def pkgs():
        love("\033[1;91m«-----------------\033[1;96mCHIMBUL OP\033[1;91m-----------------»")
        ...
        love("\033[1;91m«------------------CHIMBUL OP----------------»")
        love("\033[1;95mB4Baloch 2nd Tool Start ComingSoon New Update»")
        love("\033[1;96m «-----------------\033[1;92mCHIMBUL OP\033[1;96m--------------»")
        time.sleep(0.3)
...
##### LOGO #####
logo = """
\033[1;96mPAK HACKERS░░░\033[1;92m░░░CHIMBUL OP╗░░WEBDEVELOPER╗░AND╗░░A\033[1;91mETICALHACKER╗
\033[1;96mYT╔══M4╗B4║░\033[1;92m░░░░WEBHACKER╔══PAK╗ANONAYMOUS╔══YOUTUBE╗CHANNEL║\033[1;91m░CHIMBUL OP╔╝
\033[1;96mPAKISTANI╦╝HACKERS\033[1;92m║░░░░░███████║██║░░╚═╝\033[1;91m█████═╝░
\033[1;96mWEBHACKER╔══CHIMBUL OP╗\033[1;92m██║░░░░░██╔══██║██║░░\033[1;91m██╗██╔═██╗░
\033[1;96mWHATSAPP\033[1;92m╦╝+923043091160╗██║░░██║╚█\033[1;91m████╔╝██║░╚██╗
...
\033[1;96m«-----------------\033[1;91mCHIMBUL OP\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  BALOCH
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  HACKER
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ +923043091160
\033[1;96m«-----------------\033[1;91mCHIMBUL OP\033[1;96m-----------------»"""
...
def menu():
    ...
    print(logo)
    os.system('clear')
    os.system('echo  CHIMBUL░░░░░░OP░░PAKISTANI░ETICAL░░HACKER | lolcat -a -F 0.1')
    os.system('echo  CHIMBUL░░░░░OP██WEB██DEVELOPER░██ | lolcat -a -F 0.1')
    os.system('echo  WHATSAPP░░░░░+923043091160░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')
    os.system('echo  CONTACT  ░░░░░ME ON WHATSAPP░░ PAID HACKING░ | lolcat -a -F 0.1')
    os.system('echo  WE ARE ░░ANONAYMOUS░WE ARE LEGION WE NEVER FORFIVE | lolcat -a -F 0.1')
    os.system('echo  WE NEVER FORGET░ASPECT ░░ US ░KNOWLEDGE░IS░░FREE | lolcat -a -F 0.1')
    os.system('echo  HI, MEER HAMMAD BALOCH A ETICAL HACKER | lolcat -a -F 0.1')
    os.system('echo  WE ARE ANONYMOUS WE ARE LEGION WE NEVER FORGIVE WE NEVER FORGET ASPECT US | lolcat -a -F 0.1')
    os.system('echo  MEER HAMMAD BALOCH WHATSAPP = +923043091160 | lolcat -a -F 0.1')
    os.system('echo  VISIT OUR YOUTUBE CHANNEL CHIMBUL OP | lolcat -a -F 0.1')
    ...
    os.system('echo ----------------CHIMBUL OP-----------------| lolcat')
    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  CHIMBUL OP| lolcat --animate')
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  BALOCHHACKER| lolcat --animate')
    os.system('echo  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈| lolcat')
    os.system('echo  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp| lolcat --animate')
    os.system('echo  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈+923043091160| lolcat --animate')
    os.system('echo -----------------CHIMBUL OP----------------| lolcat --animate')
    ...
    time.sleep(0.0005)
    os.system('echo [W]  CHIMBUL OP Telegram Group-------- Tool----● | lolcat --animate')
    time.sleep(0.0005)
...
def mafia():
        ...
        if black =="":
                ...
                print (logo)
                love("\033[1;93mTool User Name :\033[1;95m     Chimbul ")
                love("\033[1;93mTool Password  :\033[1;95m     OP ")
                time.sleep(5)
